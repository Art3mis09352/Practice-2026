...
public sealed class GetOwnerPointsHandler : IRequestHandler<GetOwnerPointsQuery, FeatureResult>
{
    private readonly AppDbContext _dbContext;

    public GetOwnerPointsHandler(AppDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<FeatureResult> Handle(GetOwnerPointsQuery request, CancellationToken cancellationToken)
    {
        ...
        return new FeatureOkResult<PagedBlocksResponseDTO>(response);
    }
}
